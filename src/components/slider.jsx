  ...
  return (
    <div className="text-c3white  rounded-lg">
      <div
        ...
        className="w-52 transition-all duration-500 ease-in-out hover:scale-95 relative"
      >
        <div className="flex h-84 overflow-y-auto overflow-y-hidden opacity-0  flex-col absolute bg-black bg-opacity-40 hover:opacity-100 p-1">
          ...
          <div className="mt-3 overflow-y-auto h-44 ">{overview}</div>
          {
            ...
            <div className='flex gap-2 items-center justify-center mt-2'>
              ...
              <button onClick={() => mylist(id, original_title, overview, poster_path)} className="text-c3white bg-c1red w-24 rounded-sm font-bold">+ My List</button>
            </div>
